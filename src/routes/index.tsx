      ...
      <div className="max-w-4xl mx-auto py-12 space-y-12 select-none">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            The autonomous AI platform designed to map raw datasets to structured schema
            definitions, interactive data lineage flows, and corporate governance compliance gates.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {onboardingSteps.map((item, idx) => {
            ...
            return (
              <GlassCard
                key={idx}
                className="p-5 flex flex-col justify-between border-border/40 hover:border-primary/20 transition-all"
              >
                <div>
        ...
        <GlassCard className="p-8 border-primary/20 bg-primary/5 shadow-[0_12px_40px_rgba(242,120,92,0.05)] text-center relative overflow-hidden">
          ...
          <div className="max-w-md mx-auto space-y-6 relative z-10">
            <h3 className="font-display text-xl font-bold tracking-tight">
              Ready to map your catalog schemas?
            </h3>
            <p className="text-xs text-muted-foreground leading-relaxed">
              Ingest your own files to verify columns and data parameters, or trigger Demo Mode to
              instantly populate active lineage nodes, conversation threads, and compliance audits.
            </p>
    ...
    <div className="max-w-5xl mx-auto space-y-8 select-none">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2 border-b border-border/20">
        <div>
          <SectionTitle
            ...
            title={
              <>
                Executive Summary <span className="text-primary">Dashboard.</span>
              </>
            }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <GlassCard className="p-5 flex flex-col justify-between min-h-[140px] border-border/40">
          ...
          <div>
            <span
              className={`font-display text-3xl font-bold ${piiCount > 0 ? "text-red-500" : "text-foreground"}`}
            >
              {piiCount}
            </span>
            <p className="text-[10px] text-muted-foreground/80 mt-1 leading-snug">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-6">
        ...
        <GlassCard className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            {/* Finding 1 */}
            <div
              className="flex items-start gap-3 p-3 rounded-xl border border-red-500/15 bg-red-500/5 hover:bg-red-500/10 transition-colors cursor-pointer"
            ...
            >
              ...
              <div className="space-y-0.5">
                <h4 className="text-xs font-bold text-foreground">
                  Sensitive PII columns detected
                </h4>
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  Columns <strong>email</strong> and <strong>billing_zip</strong> contain sensitive
                  client identifiers. Unmasked records should be hashed in staging tables.
                </p>
              </div>
            </div>
            ...
            {/* Finding 2 */}
            <div
              className="flex items-start gap-3 p-3 rounded-xl border border-amber-500/15 bg-amber-500/5 hover:bg-amber-500/10 transition-colors cursor-pointer"
            ...
            >
              ...
              <div className="space-y-0.5">
                <h4 className="text-xs font-bold text-foreground">
                  Schema drift diagnostics warning
                </h4>
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  Ingestion stream detected unannounced column deletion{" "}
                  <strong>discount_code</strong> upstream in model mappings.
                </p>
              </div>
            </div>
            ...
            {/* Finding 3 */}
            <div
              className="flex items-start gap-3 p-3 rounded-xl border border-emerald-500/15 bg-emerald-500/5 hover:bg-emerald-500/10 transition-colors cursor-pointer"
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  Automated null checks, data type inferences, and primary keys successfully
            ...
            >
              ...
              <div className="space-y-0.5">
                <h4 className="text-xs font-bold text-foreground">
                  Pipeline lineage flow resolved
                </h4>
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  Resolved complete transformations path mapping raw source endpoints to
                  transactional reporting tables.
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Profile schemas & data formats",
                  to: "/dictionary",
                  icon: FileSpreadsheet,
                },
                {
                  label: "Data Lineage Map",
                  desc: "Trace column-level source-to-mart maps",
                  to: "/lineage",
                  icon: GitBranch,
                },
                {
                  label: "Governance Center",
                  desc: "Manage PII risk & SOC2 constraints",
                  to: "/governance",
                  icon: ShieldAlert,
                },
                {
                  label: "Data Sources Registry",
                  desc: "Add CSVs, DBs, or sync warehouses",
                  to: "/data-sources",
                  icon: Database,
                },
              ].map((act, idx) => {
