  ...
  return (
    <div>
      <SectionTitle
        ...
        title={
          <>
            Drop your dataset to <span className="text-primary">begin</span>.
          </>
        }
          ...
          {isProcessing ? (
            ...
            <div className="flex min-h-[340px] flex-col items-center justify-center rounded-xl border-2 border-primary/40 bg-primary/5 p-8 text-center">
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                {selectedFile ? selectedFile.name : "Dataset"} has been successfully ingested and
                profiled.
              </div>
              <div className="mt-8 flex gap-3">
                ...
                <Link
                  to="/dictionary"
                  onClick={() => {
                    localStorage.setItem("schema_sense_auto_generate", "1");
                  }}
