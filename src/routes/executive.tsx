...
import { Shield, BarChart3, AlertTriangle, Layers, BookOpen, CheckCircle, Database } from "lucide-react";
import { GlassCard, SectionTitle, CountUp, Pill } from "@/components/ui-bits";
import { EmptyState } from "@/components/EmptyState";
import { EXECUTIVE_KPI_DATA, EXECUTIVE_HEALTH_SCORECARD, EXECUTIVE_RECOMMENDATIONS } from "@/lib/executiveInsightsService";
...
export const Route = createFileRoute("/executive")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Executive overview of data governance compliance, schema quality, and metadata health." },
    ],
  }),
    ...
    return (
      <div className="py-12 space-y-8">
        <SectionTitle
          ...
          title={<>Executive <span className="text-primary">Dashboard.</span></>}
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionTitle
        ...
        title={<>Enterprise Health & <span className="text-primary">Visibility.</span></>}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        {[
          ...
          { label: "Critical Risks", val: kpis.criticalRisks, color: "text-orange-500 animate-pulse" },
          { label: "Metadata Coverage", val: kpis.metadataCoverage, suffix: "%", color: "text-emerald-500" },
        ].map((kpi, idx) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-6">
        ...
        <GlassCard className="p-6 flex flex-col gap-6 items-center">
          <div className="w-full text-left">
            ...
            <p className="text-[10px] text-muted-foreground">Overall compliance and documentation indices.</p>
          </div>
