  ...
  return (
    <div>
      <SectionTitle
        ...
        title={
          <>
            Talk to <span className="text-primary">Speech.</span>
          </>
        }
      ...
      <div className="mt-8">
        <GlassCard className="p-8 flex flex-col items-center justify-center text-center h-64">
          ...
          <p className="text-muted-foreground text-sm max-w-sm">
            This module is currently in development. Soon you will be able to speak directly to the
            AI to query your schema.
          </p>
        </GlassCard>
      </div>
    </div>
