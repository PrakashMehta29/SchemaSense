...
import { Shield, Search, Filter, AlertTriangle, ShieldCheck, Tag, Plus, Check, Trash2, Database } from "lucide-react";
import { GlassCard, SectionTitle } from "@/components/ui-bits";
import { EmptyState } from "@/components/EmptyState";
import { GOVERNANCE_ASSETS, GovernanceAsset, GovernanceTag, getRiskColor } from "@/lib/governanceService";
...
export const Route = createFileRoute("/governance")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Audit PII records, evaluate security risk scores, and manage compliance classifications." },
    ],
  }),
  ...
  if (!hasDataset) {
    return (
      <div className="py-12 space-y-8">
        <SectionTitle
          kicker="Governance"
          title={<>Data Governance <span className="text-primary">Center.</span></>}
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionTitle
        ...
        title={<>Governance <span className="text-primary">Intelligence.</span></>}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <GlassCard className="p-4 border-red-500/25 bg-red-500/5 relative overflow-hidden">
          ...
          <p className="mt-1 text-[11px] text-muted-foreground leading-relaxed">
            Standard customer emails are propagated downstream in dim_customers without cryptographic masking.
          </p>
        </GlassCard>
        ...
        <GlassCard className="p-4 border-amber-500/25 bg-amber-500/5 relative overflow-hidden">
          ...
          <h4 className="text-sm font-bold text-foreground">Missing financial metrics description</h4>
          <p className="mt-1 text-[11px] text-muted-foreground leading-relaxed">
            Revenue tracking metrics are classified as restricted but lack formal usage descriptions.
          </p>
        </GlassCard>
            ...
            return (
              ...
              >
                ...
                <div className="col-span-3">
                  <span className="font-mono-tight font-bold text-foreground block">{asset.columnName}</span>
                  {asset.piiType !== "None" && (
                ...
                <div className="col-span-2 text-right flex items-center justify-end gap-2">
                  ...
                  <span className={`inline-flex items-center justify-center w-8 py-0.5 rounded font-mono-tight font-bold border ${getRiskColor(asset.riskScore)}`}>
                    {asset.riskScore}
                  </span>
                </div>
              </li>
