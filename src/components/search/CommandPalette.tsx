...
const COMMANDS: CommandItem[] = [
  ...
  {
    id: "p-dict",
    label: "Browse Data Dictionary Catalog",
    category: "Pages",
    route: "/dictionary",
    icon: FileText,
  },
  {
    id: "p-lineage",
    label: "View Observability Data Lineage",
    category: "Pages",
    route: "/lineage",
    icon: Network,
  },
  {
    id: "p-quality",
    label: "View Data Quality Metrics",
    category: "Pages",
    route: "/quality",
    icon: BarChart3,
  },
  {
    id: "p-gov",
    label: "Browse Data Governance Center",
    category: "Pages",
    route: "/governance",
    icon: Shield,
  },
  ...
  {
    id: "c-rev",
    label: "revenue_usd · financial decimal",
    category: "Columns",
    route: "/dictionary",
    icon: FileText,
  },
  ...
  {
    id: "c-plan",
    label: "plan_tier · subscription enum",
    category: "Columns",
    route: "/dictionary",
    icon: FileText,
  },
