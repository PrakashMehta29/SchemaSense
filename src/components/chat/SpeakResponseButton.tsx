      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            aria-label={isCurrentMessageSpeaking ? "Stop listening to response" : "Listen to response"}
          >
            {isCurrentMessageSpeaking ? (
              <>
        ...
        <TooltipContent side="bottom" className="text-xs p-1.5 bg-background border text-foreground rounded-lg shadow-md">
