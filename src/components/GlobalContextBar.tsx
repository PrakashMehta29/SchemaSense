  ...
  return (
    <div className="w-full border-b border-border/40 bg-card/20 backdrop-blur-md px-6 py-2.5 flex flex-wrap items-center justify-between gap-4 z-30 relative select-none shadow-[0_1px_8px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex flex-wrap items-center gap-6 text-xs font-mono-tight">
        ...
        <div className="flex items-center gap-2">
          <CheckCircle
            className={`h-3.5 w-3.5 shrink-0 ${metadataGenerated ? "text-emerald-500" : "text-amber-500"}`}
          />
          <div className="flex flex-col">
            <span className="text-[9px] text-muted-foreground uppercase tracking-wider leading-none">
              AI Metadata
            ...
            <span
              className={`font-semibold mt-0.5 ${metadataGenerated ? "text-emerald-500" : "text-amber-500"}`}
            >
        ...
        <div className="flex items-center gap-2">
          <ShieldAlert
            className={`h-3.5 w-3.5 shrink-0 ${piiCount > 0 ? "text-red-500" : "text-muted-foreground/60"}`}
          />
          <div className="flex flex-col">
            <span className="text-[9px] text-muted-foreground uppercase tracking-wider leading-none">
              PII Detection
            ...
            <span
              className={`font-semibold mt-0.5 ${piiCount > 0 ? "text-red-500" : "text-foreground"}`}
            >
