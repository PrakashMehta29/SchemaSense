    ...
    if (score >= 95) {
      return [
        ...
        },
        {
          ...
          passed: true,
          tooltip:
            "Matches predefined formats like standard UUIDs, email patterns, or timestamp formats.",
        },
        {
    ...
    if (score >= 80) {
      return [
        ...
        },
        {
          ...
          passed: false,
          tooltip:
            "Metadata inferred mainly from database structure. Lacks active description inputs.",
        },
      ];
    }
    return [
