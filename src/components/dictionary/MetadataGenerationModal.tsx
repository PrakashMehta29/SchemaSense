...
const STAGES: Stage[] = [
  {
    ...
    desc: "Reading records, null ratios, and key densities...",
    icon: Database,
  },
  {
    label: "Detecting Column Types",
    desc: "Analyzing characters, bounds, and string structures...",
    icon: Cpu,
  },
  {
    label: "Generating Semantic Metadata",
    desc: "Synthesizing AI definitions and usage context...",
    icon: Brain,
  },
  {
    label: "Identifying Lineage & Relations",
    desc: "Correlating column names and potential foreign keys...",
    icon: Network,
  },
  {
    label: "Calculating Confidence Scores",
    desc: "Running validation rules and accuracy scores...",
    icon: BarChart2,
  },
];
