...
export const EXECUTIVE_RECOMMENDATIONS = [
  {
    ...
    description: "Column 'email' in dim_customers contains unmasked email addresses. Configure SHA-256 hashing to limit PII propagation.",
  ...
  },
  {
    ...
    description: "Ongoing schema drift detected in the ingestion pipelines. Re-profile orders.v3 mappings to restore consistency.",
    dataset: "orders.v3",
    impact: "critical",
  },
  {
    ...
    description: "Field 'churn_risk' contains high null levels and lacks corporate metadata catalog summaries.",
    dataset: "mart_growth",
    impact: "medium",
  },
];
