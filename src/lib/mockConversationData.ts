...
export const MOCK_CONVERSATIONS: ChatConversation[] = [
  {
    ...
    messages: [
      ...
      { id: "m-2", role: "ai", text: "Personally Identifiable Information (PII) is flagged in two columns in dim_customers: email (Critical) and phone_number (High). Compliance locks suggest masking these downstream.", timestamp: "10:25 AM" }
    ]
  },
  {
    id: "conv-2",
    ...
    messages: [
      ...
      { id: "m-4", role: "ai", text: "revenue_usd stores gross transactional values in US Dollars, computed by checking local purchase rates during payment processing. It is consumed by executive reporting dashboards.", timestamp: "Yesterday" }
    ]
  }
];
...
export const MOCK_INSIGHTS: AIInsightCard[] = [
  {
    ...
    description: "Fields 'email' and 'phone_number' in dim_customers contain direct identifier keys.",
    severity: "critical",
    metric: "2 Columns"
  },
  {
